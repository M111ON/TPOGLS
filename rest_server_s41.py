...
def p4_route(body: P4RouteBody):
    ...
    return JSONResponse({
        ...
        "n":            n,
        "backend":      backend,
        "path":         "GPU/T4" if backend == "cuda" else ("CPU/AVX2" if backend == "avx2" else "CPU/numpy"),
...
def health():
    ...
    return {
        ...
        "contexts": len(_contexts), "version": "S41",
...
if __name__ == "__main__":
    import uvicorn
    uvicorn.run("rest_server_s41:app", host=_HOST, port=_PORT,
